...
const Portfolio = () => {
    ...
    return (
        <section className="p-4 bg-[#1D1D1D] relative pt-16 pb-32 md:px-27 md:h-175" id="portfolio">
            <img
                src={decorleft}
                alt="Hero"
            ...
            <div className="my-8 md:flex md:flex-row md:justify-between md:gap-8">
                <div className="">
                    <Flickity options={flickityOptions} className="md:w-120 md:h-60">
                ...
                <div className="flex flex-col gap-y-4 md:gap-y-8 md:flex md:flex-col md:justify-center mt-8">
                    ...
                    <div className="text-center my-6 px-4">
                        <h2 className="text-4xl text-white mb-2 text-left md:block hidden">
                            Portfolio Kecantikan
                            Newlook Browlash
                        </h2>
                        ...
                        <p className="hidden text-lg text-white md:block text-left">
                            Setiap treatment adalah karya personal yang dirancang untuk mempertegas kecantikan alami klien kami.
                        </p>
                    </div>
